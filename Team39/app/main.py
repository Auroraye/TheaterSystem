...
#         cur.execute("call user_register(%s, %s, %s, %s);",
#                     (form.username.data, form.password.data, form.firstname.data, form.lastname.data))
#         mysql.connection.commit()
#         cur.close()
#         # flash('Account created for {form.username.data}! Wait for an administrator to approve your','success')
#         flash("Account created for {}! Wait for an administrator to approve your".format(form.username.data), 'success')
...
def admin_manage_company():
    if current_user.usertype == 'Admin' or current_user.usertype == 'CustomerAdmin':
        ...
        if form.filter.data:
            ...
            # print("call admin_filter_company(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);",
            #                         (form.companyName.data, form.cityNumberFrom.data, form.cityNumberTo.data,
            #                         form.TheatersNumberFrom.data, form.TheatersNumberTo.data, form.EmployeeNumberFrom.data,
            #                         form.EmployeeNumberTo.data,form.sortBy.data, form.sortDirection.data))
